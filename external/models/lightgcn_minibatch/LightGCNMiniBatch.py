...
from .LightGCNMiniBatchModel import LightGCNMiniBatchModel

from torch_sparse import SparseTensor


class LightGCNMiniBatch(RecMixin, BaseRecommenderModel):
    r"""
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = LightGCNMiniBatchModel(
    ...
    def get_recommendations(self, k: int = 100):
        ...
        gu, gi = self._model.propagate_embeddings(evaluate=True, adj=self.adj)
