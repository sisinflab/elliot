...
class DeepCoNNModel(tf.keras.Model, ABC):
    def __init__(self,
        ...
        self.user_review_cnn_network.append(
            (tf.Variable(
                initial_value=self.initializer([self.user_review_cnn_kernel[0][0],
                                                self.textual_words_feature_shape,
                                                self.user_review_cnn_kernel[0][1],
        ...
        for layer in range(1, len(self.user_review_cnn_features)):
            self.user_review_cnn_network.append((tf.Variable(
                initial_value=self.initializer([self.user_review_cnn_kernel[layer][0],
                                                self.textual_words_feature_shape,
                                                self.user_review_cnn_kernel[layer][1],
        ...
        self.item_review_cnn_network.append(
            (tf.Variable(
                initial_value=self.initializer([self.item_review_cnn_kernel[0][0],
                                                self.textual_words_feature_shape,
                                                self.item_review_cnn_kernel[0][1],
        ...
        for layer in range(1, len(self.item_review_cnn_features)):
            self.item_review_cnn_network.append((tf.Variable(
                initial_value=self.initializer([self.item_review_cnn_kernel[layer][0],
                                                self.textual_words_feature_shape,
                                                self.item_review_cnn_kernel[layer][1],
