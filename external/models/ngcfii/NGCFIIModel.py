...
from .NGCFIILayer import NGCFIILayer
import torch
...
class NGCFIIModel(torch.nn.Module, ABC):
    def __init__(self,
                 num_users,
                 num_items,
                 learning_rate,
        ...
        for layer in range(self.n_layers):
            propagation_network_list.append((NGCFIILayer(self.weight_size_list[layer],
        ...
        # placeholder for calculated item embeddings
