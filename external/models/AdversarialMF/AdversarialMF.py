...
from .AdversarialMatrixFactorizationModel import AdversarialMatrixFactorizationModel
...
class AdversarialMF(RecMixin, BaseRecommenderModel):
    r"""
    AdversarialMF
