...
from .kahfm_embeddings_model import KaHFMEmbeddingsModel
...
class KaHFMEmbeddings(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        # self._tfidf_obj = TFIDF({i: fs for i, fs in self._side.feature_map.items() if i in self._data.items})
        ...
        self._model = KaHFMEmbeddingsModel(self._user_factors_b.toarray(),
