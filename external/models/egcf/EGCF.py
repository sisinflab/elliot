...
class EGCF(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_nn_drop", "nn_drop", "nn_drop", 0.1, float, None),
        ...
        self._model = EGCFModel(
            ...
            node_node_mess_drop=self._nn_drop,
            edge_edge_mess_drop=self._ee_drop,
            node_edge_mess_drop=self._ne_drop,
            att_drop=self._att_drop,
