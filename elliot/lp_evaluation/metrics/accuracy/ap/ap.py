...
class AP(BaseMetric):
    ...
    def __triple_ap(self, rank: int, cutoff: int):
        """
        ...
        """
        return 1 / rank if rank <= cutoff else 0
    ...
    def eval_triple_metric(self):
        ...
        return [self.__triple_ap(rank, self._cutoff) for rank in self._ranks_l + self._ranks_r]
