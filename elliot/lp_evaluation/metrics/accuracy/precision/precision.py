...
class Precision(BaseMetric):
    ...
    def __triple_precision(self, rank: int, cutoff: int):
        """
        ...
        """
        return 1 / cutoff if rank <= cutoff else 0
    ...
    def eval_triple_metric(self):
        ...
        return [self.__triple_precision(rank, self._cutoff) for rank in self._ranks_l + self._ranks_r]
