...
class MRRAtN(BaseMetric):
    ...
    @staticmethod
    def __get_reciprocal_rank(rank, cutoff):
        return 1.0 / rank if rank <= cutoff else 0
    ...
    def eval_triple_metric(self):
        ...
        """
        return [MRRAtN.__get_reciprocal_rank(rank, self._cutoff) for rank in self._ranks_l + self._ranks_r]
