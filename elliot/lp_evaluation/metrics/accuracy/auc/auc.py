...
class AUC(BaseMetric):
    ...
    def __init__(self, ranks_l: t.List[int], ranks_r: t.List[int], config, params, eval_objects):
        ...
        self._n = len(self._evaluation_objects.entity_to_index)
    ...
    def __triple_auc(self, rank: int, n: int):
        """
    ...
    def eval_triple_metric(self):
        ...
        return [self.__triple_auc(rank, self._n) for rank in self._ranks_l + self._ranks_r]
