...
from recommender.latent_factor_models.LogisticMF.logistic_matrix_factorization_model import LogisticMatrixFactorizationModel
...
class LogisticMatrixFactorization(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = LogisticMatrixFactorizationModel(self._num_users, self._num_items, self._factors,
                                                       self._l_w, self._alpha, self._learning_rate)
